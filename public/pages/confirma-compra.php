<div class="img-forms">
    ...
    <form id="form" class="colorful-form" method="post" action="?page=salvar-endereco">
        ...
        <div class="form-group">
            <label class="form-label" for="tipo">Digite o tipo: </label>
            <input required="" placeholder="digite o tipo" class="form-input" name="tipo" id="tipo" type="number">
        </div>
